      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              Your trusted moving partner in Australia. We provide professional, reliable, and affordable moving solutions
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/packing" className="text-gray-600 hover:text-teal-600 transition-colors">
                  Packing & Unpacking
                </Link>
              </li>
              <li>
                <Link href="/services/transport" className="text-gray-600 hover:text-teal-600 transition-colors">
                  Transportation
                </Link>
              </li>
              <li>
                <Link href="/services/storage" className="text-gray-600 hover:text-teal-600 transition-colors">
                  Storage Services
                </Link>
              </li>
              <li>
                <Link href="/services/office" className="text-gray-600 hover:text-teal-600 transition-colors">
                  Office Moving
                </Link>
              </li>
              <li>
                <Link href="/services/insurance" className="text-gray-600 hover:text-teal-600 transition-colors">
                  Insurance
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-700">+977-9851331114</p>
              </div>
              <div className="flex items-center space-x-3">
                <svg
                  className="w-5 h-5 text-teal-600 flex-shrink-0"
                ...
                <p className="text-gray-700">himalayaremovals@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* <div className="border-t border-gray-300 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">© 2024 Himalaya Removals. All rights reserved.</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="/privacy" className="text-gray-600 hover:text-teal-600 text-sm transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-gray-600 hover:text-teal-600 text-sm transition-colors">
                Terms of Service
              </Link>
              <Link href="/sitemap" className="text-gray-600 hover:text-teal-600 text-sm transition-colors">
                Sitemap
              </Link>
            </div>
          </div>
